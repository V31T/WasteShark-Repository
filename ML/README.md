...
Camera → YOLOv5s and navigation → Pixhawk  → MQTT → Motors
...
This document summarizes the complete ML pipeline — from YOLOv5 training and headless inference on the Raspberry Pi 5 to telemetry publishing, navigation integration, and backend data streaming for the WasteShark autonomous trash collection system.
